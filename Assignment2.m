...
if handPos(1,3)<1 && Cyton.taskExecutionFlag==3
    ...
    Cyton.DropBrick2();             % This command is used to pick second Brick and place it on the  specified position on the wall ;
end
...
if handPos(1,3)<1 && Cyton.taskExecutionFlag==5
    ...
    Cyton.DropBrick3();             % This command is used to pick third Brick and place it on the  specified position on the wall ;
